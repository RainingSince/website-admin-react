      ...
      <Form style={{ width: '300px' }}>
        ...
        <Form.Item label="名称">
          {getFieldDecorator('name', {
            rules: [{ required: true, message: 'Please enter catalog name' }],
          })(<Input placeholder="请输入分类名称"/>)}
        </Form.Item>


        <Form.Item label="排序">
          {getFieldDecorator('sort')(<Input placeholder="请输入分类排序"/>)}
        </Form.Item>

        <Form.Item label="描述">
          {getFieldDecorator('remark')(<Input placeholder="请输入分类描述"/>)}
        </Form.Item>
